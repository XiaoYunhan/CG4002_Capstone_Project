...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    return qnn.QuantConv1d(in_planes, out_planes, kernel_size=3, stride=stride,
                     padding=1, bias=False, weight_quant_type=QuantType.FP, weight_bit_width=8)

def conv5x5(in_planes, out_planes, stride=1):
    return qnn.QuantConv1d(in_planes, out_planes, kernel_size=5, stride=stride,
                     padding=1, bias=False, weight_quant_type=QuantType.FP, weight_bit_width=8)

def conv7x7(in_planes, out_planes, stride=1):
    return qnn.QuantConv1d(in_planes, out_planes, kernel_size=7, stride=stride,
                     padding=1, bias=False, weight_quant_type=QuantType.FP, weight_bit_width=8)
...
class QuantMSResNet(nn.Module):
    def __init__(self, input_channel, layers=[1, 1, 1, 1], num_classes=10):
        ...
        # maxplooing kernel size: 16, 12, 7
