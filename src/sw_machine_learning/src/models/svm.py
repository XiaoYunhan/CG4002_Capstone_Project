...
if __name__ == "__main__":
    ...
    X_train, X_test, Y_train, Y_test = import_data(os.getcwd() + '/../../../../data/Raw Data/wk9/compiled.txt')

    rbf.fit(X_train, Y_train.ravel())
    y_predict = rbf.predict(X_test)
    dump(rbf, os.getcwd() + '/../../models/rbf.joblib')
    rbf = load(os.getcwd() + '/../../models/rbf.joblib')
    y_predict = rbf.predict(X_test)
